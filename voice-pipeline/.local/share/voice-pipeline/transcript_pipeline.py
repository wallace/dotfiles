...
The original transcript is never modified. Outputs are written alongside it as
"<stem> - Summary.md" (and "<stem> - Clean.md" with --clean-transcript).
"""
...
def render_note(stem, frontmatter, data, recorded, people):
    L = [frontmatter, ""]
...
def main():
    ...
    ap.add_argument("--clean-transcript", action="store_true",
                    help="Also write a named, de-noised transcript file.")
    args = ap.parse_args()
